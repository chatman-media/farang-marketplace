...
**Порт разработки:** 3004 **Описание:** Система бронирования и управления
транзакциями **Основные функции:**
...
**Порт разработки:** 3003 **Описание:** Интеграция платежей с TON blockchain
**Основные функции:**
...
| Voice Service   | 56                | 80%+     | ✅ Мигрирован  |
...
- **[Миграция на Fastify](./fastify-migration.md)** - Подробная информация о
  миграции с Express.js
