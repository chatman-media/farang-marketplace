...
describe('Booking Integration Service Tests', () => {
  ...
  describe('Service Matching Logic', () => {
    ...
    it('should calculate commission correctly', () => {
      const testCases = [
        { basePrice: 1000, commissionRate: 0.15, expectedCommission: 150, expectedTotal: 1150 },
        { basePrice: 500, commissionRate: 0.10, expectedCommission: 50, expectedTotal: 550 },
        { basePrice: 2000, commissionRate: 0.20, expectedCommission: 400, expectedTotal: 2400 },
      ];
  ...
  describe('Match Scoring Algorithm', () => {
    it('should calculate match scores correctly', () => {
      ...
      const testCases = [
        { rating: 5, distance: 5, pricePosition: 0.2, availability: true, expectedMin: 85 },
        { rating: 4, distance: 10, pricePosition: 0.5, availability: true, expectedMin: 70 },
        { rating: 3, distance: 25, pricePosition: 0.8, availability: false, expectedMin: 30 },
      ];

      testCases.forEach(({ rating, distance, pricePosition, availability, expectedMin }) => {
        const score = calculateMatchScore({ rating, distance, pricePosition, availability });
