...
router.get("/providers", (req, res) => oauthController.getAvailableProviders(req, res))
...
router.post("/:provider/callback", (req, res) => oauthController.handleOAuthCallback(req, res))
