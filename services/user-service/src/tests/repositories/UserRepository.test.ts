...
describe('UserRepository', () => {
  ...
  describe('findByTelegramId', () => {
    it('should find user by telegram id successfully', async () => {
      ...
      const result = await userRepository.findByTelegramId(
  ...
  describe('bulkUpdateRole', () => {
    it('should update multiple users role', async () => {
      ...
      const result = await userRepository.bulkUpdateRole(
        userIds,
        UserRole.AGENCY
      );
