...
describe('UserEntity', () => {
  ...
  describe('Validation Methods', () => {
    ...
    it('should validate update user data', () => {
      ...
      expect(() =>
        UserEntity.validateUpdateData(validUpdateData)
      ).not.toThrow();
    });
    ...
    it('should validate password change data', () => {
      ...
      expect(() =>
        UserEntity.validatePasswordChange(validPasswordData)
      ).not.toThrow();
    });
    ...
    it('should reject invalid password change data', () => {
      ...
      // Test missing fields
      expect(() =>
        UserEntity.validatePasswordChange({ currentPassword: 'oldpassword' })
      ).toThrow();
      expect(() =>
        UserEntity.validatePasswordChange({ newPassword: 'newpassword123' })
      ).toThrow();
