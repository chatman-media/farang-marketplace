...
export const payments = pgTable(
  ...
  (table) => ({
    ...
    tonTxHashIdx: index('payments_ton_tx_hash_idx').on(
      table.tonTransactionHash
    ),
...
export const transactions = pgTable(
  ...
  (table) => ({
    ...
    tonTxHashIdx: index('transactions_ton_tx_hash_idx').on(
      table.tonTransactionHash
    ),
...
export const paymentMethods = pgTable(
  ...
  (table) => ({
    ...
    tonWalletIdx: index('payment_methods_ton_wallet_idx').on(
      table.tonWalletAddress
    ),
  })
);
