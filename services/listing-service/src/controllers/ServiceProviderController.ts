...
export class ServiceProviderController {
  ...
  async createServiceProvider(req: Request, res: Response) {
    try {
      ...
      const serviceProvider =
        await this.serviceProviderService.createServiceProvider(serviceProviderData)
  ...
  async updateServiceProvider(req: Request, res: Response) {
    try {
      ...
      const serviceProvider = await this.serviceProviderService.updateServiceProvider(
        id,
        updateData,
        userId
      )
