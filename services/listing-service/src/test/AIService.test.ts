...
describe("AIService", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should set default provider correctly", () => {
      ...
      expect(() => aiService.setDefaultProvider(AIProvider.OPENAI)).not.toThrow()
    })
  ...
  describe("Enhanced Search", () => {
    ...
    it("should handle API errors gracefully", async () => {
      ...
      expect(result.aiInsights.queryUnderstanding).toContain("AI enhancement failed")
    })
            ...
            choices: [
              {
                message: {
                  content: JSON.stringify({
                    ...
                    suggestions: ["scooter rental Bangkok", "motorbike hire Bangkok"],
                    confidence: 85,
                  }),
                },
              },
